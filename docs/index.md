...
The software is developed by [A.N. Marimuthu](https://github.com/aravindhnivas). It provides a user-friendly interface for analyzing spectra obtained from the FELion instrument.
